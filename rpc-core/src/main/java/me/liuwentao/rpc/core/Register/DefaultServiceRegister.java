...
public class DefaultServiceRegister implements ServiceRegister{
    ...
    @Override
    public synchronized <T> void register(T service) { // 这个service是具体的服务实现类，eg:HelloServiceImpl
    ...
    @Override
    public synchronized Object getService(String interfaceName) { // 这里传入你需要调用的接口名，会返回这个接口对应的服务实现类
